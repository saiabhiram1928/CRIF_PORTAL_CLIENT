...
import DoughnutPlot from "../Plots/DoughnutPlot/DoughnutPlot";
import Legend from "../Plots/Legend/Legend";
import SizedFlexBox from "../Utility/SizedFlexBox";

const DoughnutPlotWLegend = (props) => {
    ...
    <React.Fragment>
      ...
      >
        <DoughnutPlot
          ...
          height="95%"
        />
        <Legend legendItems={legendItems} key="1" textColor={props.textColor} />
      </SizedFlexBox>
    </React.Fragment>
  );
};

export default DoughnutPlotWLegend;
