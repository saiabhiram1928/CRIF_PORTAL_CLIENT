...
const CDORD = (props) => {
  ...
  const onSubmit = (data) => {
    ...
    processedData.exp_wavelength = data.exp_wavelength;
    ...
    props.setTotalPrice(
      props.totalPrice + 150
    );
    reset({ sample_code: "", solubility: "", exp_wavelength: "" });
  ...
  const analysisOptions = [
    { value: "CD", label: "CD" },
    { value: "ORD", label: "ORD" },
    { value: "Flouroscence", label: "Flouroscence" },
  ];
      ...
      <div className={styles["two-fields"]}>
        ...
        >
          <input
            ...
            {...register("exp_wavelength", {
              required: true,
            })}
          />
          <p className={gstyles["field-error"]}>
            {errors.exp_wavelength?.type === "required" &&
