...
const ICPOES = (props) => {
  ...
  let tariff = {
    int_stu: {
      "Single Element": 150,
      "Multiple Elements": 200,
      "Emission Spectrum": 200,
    },
  ...
  const onSubmit = (data) => {
    ...
    processedData.expected_wavelength = data.expected_wavelength;
    processedData.expected_concentration = data.expected_concentration;
    ...
    reset({ sample_code: "", solubility: "", expected_wavelength: "", expected_concentration: "" });
  ...
  const analysisOptions = [
    { value: "Single Element", label: "Single Element" },
    { value: "Multiple Elements", label: "Multiple Elements" },
    { value: "Emission Spectrum", label: "Emission Spectrum" },
  ];
      ...
      <div className={styles["two-fields"]}>
        ...
        >
          <input
            ...
            style={{ width: "100%", height: "2.4vw" }}
            type="text"
            placeholder="Expected Wavelength"
            {...register("expected_wavelength", {
              required: true,
            })}
          />
          <p className={gstyles["field-error"]}>
            {errors.expected_wavelength?.type === "required" &&
              "Expected Wavelength is Required"}
          </p>
        </div>
        ...
        >
          <input
            ...
            style={{ width: "100%", height: "2.4vw" }}
            type="text"
            placeholder="Expected Concentration"
            {...register("expected_concentration", {
              required: true,
            })}
          />
          <p className={gstyles["field-error"]}>
            {errors.expected_concentration?.type === "required" &&
              "Expected Concentration is Required"}
          </p>
        </div>
      </div>
      <MarginBox margin="0.6vw" />
