...
const Applications = () => {
  ...
  const getApplicationsData = useCallback(async () => {
    ...
    await axios
      .get(
        process.env.REACT_APP_BACKEND_API_URL + "/applications/getAllForAdmin"
      )
      .then((response) => {
                ...
                if (key !== "application_id") {
                  if (counter % 4 === 0 || counter % 4 === 3) {
                    sampleRender.push(
                      ...
                      >
                        <p className={style["value2"]}>{sample[key]}</p>
                        <p className={style["label2"]}>{key}</p>
                      </div>
                    );
                  } else {
                    sampleRender.push(
              ...
              >
                <div className={style["innercard"]}>
                  ...
                  >
                    ...
                    >
                      <p className={style["value"]}>{item.application_id}</p>
                      <p className={style["label"]}>Application Id</p>
                    </div>
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      <p className={style["value"]}>{item.instrument_code}</p>
                      <p className={style["label"]}>Instrument Code</p>
                    </div>
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      <p className={style["value"]}>{item.status}</p>
                    ...
                    >
                      <p className={style["value"]}>{item.pricing}</p>
                      <p className={style["label"]}>Pricing</p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    >
                      <p className={style["value"]}>{item.department}</p>
                      <p className={style["label"]}>Student Department</p>
                    </div>
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      <p className={style["value"]}>{item.role}</p>
                      <p className={style["label"]}>Student Type</p>
                    </div>
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      <p className={style["value"]}>{item.supervisor_name}</p>
                      <p className={style["label"]}>Supervisor Name</p>
                    </div>
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      ...
                      <p className={style["label"]}>Supervisor Department</p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    >
                      <p className={style["value"]}>{item.toxicity}</p>
                      <p className={style["label"]}>Toxicity</p>
                    </div>
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      <p className={style["value"]}>{item.incompatibility}</p>
                      <p className={style["label"]}>Incompatibility</p>
                    </div>
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      <p className={style["value"]}>{item.health_hazard}</p>
                      <p className={style["label"]}>Health Hazard</p>
                    </div>
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      <p className={style["value"]}>{item.sample_properties}</p>
                      <p className={style["label"]}>Sample Properties</p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    >
                      <p className={style["value"]}>{item.first_aid}</p>
                      <p className={style["label"]}>First Aid</p>
                    </div>
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      <p className={style["value"]}>{item.disposal}</p>
                      <p className={style["label"]}>Disposal</p>
                    </div>
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      <p className={style["value"]}>{item.additional_info}</p>
                      <p className={style["label"]}>Additional Information</p>
                    </div>
                  </div>
                  <div key="samplesRender">{samplesRender}</div>
                  <div
                    style={{ display: "flex", justifyContent: "space-between" }}
                  >
                    <div className={style["normal-button"]}>
                          ...
                          if (result.isConfirmed) {
                            ...
                            await axios.get(
                                ...
                                "/mailer/sendMail",
                              {
                                params: {
                                  email: item.email,
                                  subject: "CRIF APPLICATION REJECTED",
                    ...
                    >
                      <p className={style["button-text"]}>REJECT APPLICATION</p>
                    </div>
                    <div
                      ...
                      onClick={async () => {
                        MySwal.fire({
                          ...
                          if (result.isConfirmed) {
                            ...
                            await axios.get(
                              process.env.REACT_APP_BACKEND_API_URL +
                                "/applications/adminApproveApplication",
                              {
                                params: {
                                  application_id: item.application_id,
                                },
  ...
  return (
    <MainContent>
      <TextBanner height="8vw" bgColor={ColorPalette.violet.light}>
        <p className={gstyles["banner-main-text-dark"]}>Applications</p>
