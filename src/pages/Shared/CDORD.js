...
const CDORD = () => {
  ...
  const submitApplication = () => {
    ...
    applicationData.instrument_code = "CDORD";
    ...
    MySwal.fire({
      ...
      if (result.isConfirmed) {
        ...
        Object.keys(formData).forEach(async (key) => {
          ...
          await axios.post(
            process.env.REACT_APP_BACKEND_API_URL + "/cdord/createItem",
            formData[key]
          );
        });
